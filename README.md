...
- **Portable data:** Review imported CSV rows or batches of supported Greenhouse, Lever, Gem, Rippling ATS, 4 Day Week, Y Combinator Work at a Startup, and public `JobPosting` JSON-LD URLs before explicitly saving, and export applications as CSV or formatted XLSX.
