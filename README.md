...
- **Portable data:** Review imported CSV rows or supported Greenhouse, Lever, and public `JobPosting` JSON-LD URLs before explicitly saving, and export applications as CSV or formatted XLSX.
