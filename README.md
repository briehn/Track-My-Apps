...
- **Portable data:** Review imported CSV rows or batches of supported Greenhouse, Lever, Gem, and public `JobPosting` JSON-LD URLs before explicitly saving, and export applications as CSV or formatted XLSX.
