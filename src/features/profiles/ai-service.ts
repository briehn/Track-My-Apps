          ...
          content: [
            {
              ...
              text: [
                ...
                "yearsOfExperience should include the strongest explicit signal from the resume when available.",
                "If the resume explicitly indicates no professional experience, entry-level, recent graduate, internship-only, bootcamp graduate, or less than one year, set yearsOfExperience to ZERO_TO_ONE.",
                "If years are explicit, map to: ZERO_TO_ONE for 0-1, ONE_TO_TWO for 1-2, THREE_TO_FIVE for 3-5, SIX_TO_NINE for 6-9, TEN_PLUS for 10+.",
                "If the resume gives no clear years signal, set yearsOfExperience to null.",
